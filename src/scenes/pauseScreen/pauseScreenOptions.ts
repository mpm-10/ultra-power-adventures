...
export default class pauseScreenOptions extends Phaser.Scene
{
    v! : GlobalVariables;
    axiosImp! : AxiosImp;
    ...
    preload() : void
    {
        this.load.image('skill1', './assets/scenes/pauseScreen/skill1.png');
        this.load.image('skill2', './assets/scenes/pauseScreen/skill2.png');
        this.load.image('skill3', './assets/scenes/pauseScreen/skill3.png');
        this.load.image('skill4', './assets/scenes/pauseScreen/skill4.png');
        this.load.image('skill5', './assets/scenes/pauseScreen/skill5.png');
    }
    ...
    create() : void
    {
        ...
        {
            this.v.selected_powers[this.v.power1_position] = true;
            this.v.disponible_powers[this.v.power1_position] = false;
        }

        if(this.v.power2 > 0 && this.v.power2 < 6)
        {
            this.v.selected_powers[this.v.power2_position] = true;
            this.v.disponible_powers[this.v.power2_position] = false;
        }
        ...
        let description_skill3 : string = "Poder 3:\n\n" + 
                                          "-Aumenta o Ataque em 4x por 15s\n" + 
